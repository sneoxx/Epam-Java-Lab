...
public class ReflectionService {
    ...
    public boolean checkValueFieldsAnnotation(Object object) {
        ...
        for (Field field : declaredFields) {
            ...
            log.trace("checkValueFieldsAnnotation11() - Найдена Value аннотация на поле: {}", field.getName());
        }
        return true;
    }
    ...
    public void checkAndFillFieldsWithValueAnnotation(Object object, Object valueAnnotation) {
        log.info("checkAndFillFieldsWithValueAnnotation() - На заполнение в объект: {} и передано значение valueAnnotation: {}", object.getClass().getTypeName(), valueAnnotation);
        try {
